...
// import { cocTemplateCertificate , CocTemplateCertificate } from "../templates/samples";
// import percySnapshot from "@percy/testcafe";

// // assign certificate to a variable otherwise there is an error ... ReferenceError: sample_1 is not defined
// const document: CocTemplateCertificate  = {
//   ...cocTemplateCertificate,
//   $template: { ...cocTemplateCertificate.$template, name: "red" }
// };
